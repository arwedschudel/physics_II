...
This is the noise created in a one-dimensional circuit (like a coax-cable). \\Classical Limit $\hslash\omega << k_bT$ 
...
\begin{tabular}{cc}
	...
	\begin{tabular}{c}
		...
		\begin{tabular}{c}
			...
			$N(k)= \frac{k}{\pi /L} \qquad D(k)=\dfrac{dN}{dk}\dfrac{1}{L}=\dfrac{1}{\pi}$\\
			$u(\omega)d\omega = \frac{1}{\pi c'}k_bT d\omega$\\
			$P=\frac{1}{2}\pi k_bT d\omega = k_bT d\nu$
		\end{tabular}
	\end{tabular}
\end{tabular}
\end{donotbrake}
